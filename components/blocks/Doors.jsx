...
const FireProof = () => {
  return (
    <div>
      <div className="flex xl:flex-row flex-col xl:gap-32 gap-12">
        <div className="flex-1" data-aos="fade-right">
          Протипожежні двері та ворота - це важлива частина будь-якої будівлі,
          яка забезпечує безпеку та захист в разі виникнення пожежі. Вони
          спеціально розроблені для утримання поширення вогню та диму з однієї
          зони на іншу, забезпечуючи захист людей і майна, надаючи час на
          евакуацію та дозволяючи пожежним боротися з вогнем.
        </div>
        <div className="flex md:flex-row flex-col gap-6 md:items-start justify-center items-center">
          <Image
            data-aos="fade-left"
...
const RayProof = () => {
  return (
    <div>
      <div className="flex xl:flex-row flex-col xl:gap-32 gap-12">
        <div className="flex-1" data-aos="fade-right">
          Рентгенозахисні двері, ставні, ширми та вікна є важливим елементом
          безпеки в медичних установах, дослідницьких лабораторіях та інших
          місцях, де використовують рентгенівське обладнання. Вони призначені
          для захисту персоналу та навколишнього середовища від шкідливого
          випромінювання радіації, яке може виділятися під час проведення
          рентгенівських процедур.
        </div>
        <div className="flex md:flex-row flex-col gap-6 md:items-start justify-center items-center">
          <Image
            data-aos="fade-left"
